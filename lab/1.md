...
- **Chapter 6 (Optional): GitHub Copilot SDK with Local AI Models** ⭐ NEW  
  Learn to run your agent locally using Microsoft Foundry Local for privacy and cost savings
